...
command -v update-grub >/dev/null || command -v grub-mkconfig >/dev/null || { echo "update-grub/grub-mkconfig not found; refusing (no network installs in lab)" >&2; exit 69; }
