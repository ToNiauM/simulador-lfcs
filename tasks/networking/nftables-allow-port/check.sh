...
c2 = criterion("rule_persistent", bool(match), 3, "persistent nftables configuration contains the accept rule", match.group(0) if match else "rule not found in /etc/nftables.conf or its includes")
